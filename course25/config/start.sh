...
#####
set -e
python3 /srv/config/database-check.py
while [[ $? != 0 ]] ; do
...
if [ "$PRODUCTION" == "true" ]; then
    ...
    python3 /srv/starter/manage.py migrate --fake-initial
    ...
    python3 /srv/starter/manage.py collectstatic --noinput -v 3
else
    ...
    python3 /srv/starter/manage.py flush --noinput
